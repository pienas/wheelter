...
PartnersLogs.authenticate = { redirectTo: "/login" }
PartnersLogs.suppressFirstRenderFlicker = true
PartnersLogs.getLayout = (page) => <Layout title="Veiksmų žurnalas ・ Wheelter">{page}</Layout>
