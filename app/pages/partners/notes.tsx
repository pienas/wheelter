...
PartnersNotes.authenticate = { redirectTo: "/login" }
PartnersNotes.suppressFirstRenderFlicker = true
PartnersNotes.getLayout = (page) => <Layout title="Užrašinė ・ Wheelter">{page}</Layout>
